...
# Write to file:
with open('../3-results/typical_normalized/freesound.txt','w') as f:
    f.write('\n'.join(result['freesound']))

with open('../3-results/typical_normalized/crowd.txt','w') as f:
    f.write('\n'.join(result['crowd']))
...
# Write to file:
with open('../3-results/typical_raw/freesound.txt','w') as f:
    f.write('\n'.join(result['freesound']))

with open('../3-results/typical_raw/crowd.txt','w') as f:
    f.write('\n'.join(result['crowd']))
